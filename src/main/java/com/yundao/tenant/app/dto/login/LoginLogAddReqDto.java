...
public class LoginLogAddReqDto {
    ...
    private String systemCode = AppTypeEnum.B_APP.getType();
    ...
    public void setLoginAddress(AddressData addressData) {
        if(addressData != null){
            this.loginAddress = addressData.getRegion() + addressData.getCity();
        }
